...
def get_prediction(data: InputData):
    ...
    cols_new =['open', 'high', 'low', 'close', 'volume', 'OBV', 'RSI', 'Fib_1',
       'Fib_2', 'Fib_3', 'Fib_4', 'K', 'D', 'SAR', 'EP', 'AF', 'DI_plus',
       'DI_minus', 'ADX', 'MACD', 'SignalLine', 'MACD Histogram',
       'Middle Band', 'Upper Band', 'Lower Band', 'sin_high', 'sin_low',
